...
CREATE TABLE shows (
	...
	CONSTRAINT categoryID_fk
		FOREIGN KEY (categoryID)
			REFERENCES showCategory (showCategoryID),
...
CREATE TABLE productionExpense(
	productionExpenseID int NOT NULL,
	weeklyExpenseID int NOT NULL,
	productionID int NOT NULL,
...
CREATE TABLE operatingExpense(
	operatingExpenseID int NOT NULL,
	weeklyExpenseID int NOT NULL,
	operatingCategoryID int NOT NULL,
	amount DECIMAL(12,2),
	address varchar(50),
